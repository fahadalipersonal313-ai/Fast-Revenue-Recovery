...
def render_invoice_pdf(data: InvoiceData) -> bytes:
    ...
    # Palette — mirrors the app's premium look (slate ink + single indigo accent).
    INK = colors.HexColor("#0f172a")     # near-black headings/values
    BODY = colors.HexColor("#1e293b")    # body text
    MUTED = colors.HexColor("#64748b")   # labels / secondary
